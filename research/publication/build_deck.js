...
/* ───────────────── 12. Reproducibility ───────────────── */
{
  ...
  stat(4.80, "1,145", "non-browser tests passing —\n502 backend, 643 simulation");
  ...
  s.addText("Scope: simulation results are artifact-backed. Analytical results are derivation-backed and external facts are literature-backed; neither is covered by the checksum table. The 1,145 figure is non-browser: 502 backend and 643 simulation. Nine browser checks are defined and excluded from it. They executed and passed 9/9 in an independent run on macOS 26.0 arm64 / Playwright Chromium at commit dcbfc3b; every input they exercise is byte-identical at HEAD. Where Chromium is absent they skip, and a skip is never counted as a pass.",
