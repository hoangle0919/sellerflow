...
/* ───────────────── 12. Reproducibility ───────────────── */
{
  ...
  stat(4.80, "1,138", "non-browser tests passing —\n495 backend, 643 simulation");
  ...
  s.addText("Scope: simulation results are artifact-backed. Analytical results are derivation-backed and external facts are literature-backed; neither is covered by the checksum table. The 1,138 figure is non-browser: 495 backend and 643 simulation. Nine browser checks are defined and excluded from it. They were rewritten in this pass and have NOT executed since — Chromium is unavailable here, so they skip, and a skip is not a pass. Browser execution is an open external gate.",
