...
- **Analytical backbone:** `research/DERIVATIONS.md` — seven propositions with proofs, holding for **any** revenue path independent of simulation, parameter choice, or distributional assumption. Each is validated against the engine by test. The simulations illustrate proven structural relationships; they do not estimate real-world impact.
